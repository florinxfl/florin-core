...
CJNIEXPORT void JNICALL Java_com_florin_jniunifiedbackend_IWitnessController_00024CppProxy_setAccountCompounding(JNIEnv* jniEnv, jobject /*this*/, jstring j_witnessAccountUUID, jint j_percentToCompount)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT jint JNICALL Java_com_florin_jniunifiedbackend_IWitnessController_00024CppProxy_isAccountCompounding(JNIEnv* jniEnv, jobject /*this*/, jstring j_witnessAccountUUID)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
