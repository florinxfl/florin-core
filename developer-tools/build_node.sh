...
if test -f "build_node/src/.libs/lib_unity_node_js-0.dll"; then
    cp build_node/src/.libs/lib_unity_node_js-0.dll src/frontend/electron/lib_unity.node
    ...
    cp build_node/src/.libs/lib_unity_node_js.so src/frontend/electron/lib_unity.node
